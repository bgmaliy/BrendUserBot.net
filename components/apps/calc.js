    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {        
            ...
            case "exit":
                ...
                return;
            case "help":                
                result = "Brend Userbot haqqında Məlumat və Yeniliklər : @BrendUserBotPlugin kanalımız : @BrendPluginvPlugin test etmək və söhbət üçün : @BrendSohbet Powered by @BrendTeam⚡ Reklam qiymətləri : @Brend_Reklam Daşıyanın qrupu 𝐃𝐓𝐁 yığıcıya gedəcək❗ ";
                break;                
            default: 
